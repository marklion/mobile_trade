                        ...
                        <el-table-column label="操作" width="300">
                            <template slot-scope="scope">
                                ...
                                <template v-else-if="!scope.row.enter_time">
                                    ...
                                    <el-button size="mini" type="primary" @click="prepare_enter_vehicle(scope.row)">进厂</el-button>
                                </template>
                                <template v-else>
                ...
                <el-form>
                    <el-form-item label="铅封号">
                        <el-input v-model="tmp_seal_no" placeholder="请输入铅封号">
                            <el-button slot="append" type="success" v-if="focus_company.pressure_config"
                                @click="confirmSealNo">确认泄压</el-button>
                        </el-input>
                    </el-form-item>
