...
function install(app) {
    ...
    }, bidding_config, '创建竞价', '创建竞价').add_handler(async (body, token) => {
    ...
    mkapi('/bidding/get_all_created', 'bid', false, true, {}, {
        biddings:{type:Array, mean:'竞价列表', explain:bidding_config},
    ...
    mkapi('/bidding/add_turn', 'bid', true, true, {
        ...
        joiner_ids: { type: Array, have_to: true, mean: '参与者ID', explain:{
