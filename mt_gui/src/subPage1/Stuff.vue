<template>
    ...
    export default {
        ...
        methods: {
            ...
            // 为每个配置生成对应的get/set方法
            get_show_sc_in_field: function() { return this.getGlobalConfig('show_sc_in_field'); },
            set_show_sc_in_field: function() { return this.setGlobalConfig('show_sc_in_field'); },
            get_buy_config_hard: function() { return this.getGlobalConfig('buy_config_hard'); },
            set_buy_config_hard: function() { return this.setGlobalConfig('buy_config_hard'); },
            get_push_messages_writable_roles: function() { return this.getGlobalConfig('push_messages_writable_roles'); },
            set_push_messages_writable_roles: function() { return this.setGlobalConfig('push_messages_writable_roles'); },
            get_ticket_hasOrhasnt_place: function() { return this.getGlobalConfig('ticket_hasOrhasnt_place'); },
            set_ticket_hasOrhasnt_place: function() { return this.setGlobalConfig('ticket_hasOrhasnt_place'); },
            get_access_control_permission: function() { return this.getGlobalConfig('access_control_permission'); },
            set_access_control_permission: function() { return this.setGlobalConfig('access_control_permission'); },
            get_barriergate_control_permission: function() { return this.getGlobalConfig('barriergate_control_permission'); },
            set_barriergate_control_permission: function() { return this.setGlobalConfig('barriergate_control_permission'); },
            get_support_location_detail: function() { return this.getGlobalConfig('support_location_detail'); },
            set_support_location_detail: function() { return this.setGlobalConfig('support_location_detail'); },
            get_is_allowed_order_return: function() { return this.getGlobalConfig('is_allowed_order_return'); },
            set_is_allowed_order_return: function() { return this.setGlobalConfig('is_allowed_order_return'); },
            get_the_order_display_price: function() { return this.getGlobalConfig('is_the_order_display_price'); },
            set_the_order_display_price: function() { return this.setGlobalConfig('is_the_order_display_price'); },
        },
        onPullDownRefresh() {
