...
<fui-modal :zIndex="1002" :buttons="[]" v-if="show_manual_weight" :show="show_manual_weight">
    <fui-form ref="form" :disabled="plan_owner">
        ...
        <fui-form-item>
            <fui-upload max="4" width="80" height="80" callUpload :fileList="first_weight_fileUrl" :sizeType="['compressed']" ref="first_weight_upload"
             @reupload="reupload_first_weight" @error="meet_upload_error" @complete="after_first_weight_action" />
        </fui-form-item>
        ...
        <fui-form-item>
            <fui-upload max="4" width="80" height="80" callUpload :fileList="second_weight_fileUrl" :sizeType="['compressed']" ref="second_weight_upload"
             @reupload="reupload_second_weight" @error="meet_upload_error" @complete="after_second_weight_action"></fui-upload>
        </fui-form-item>
